...
- **Experimental:** `window.inference.experimental` — `request` is a deprecated alias of stable `request`; `runTools` (Bridge DevTools helper; shipped apps should use [`ipa-tools`](https://www.npmjs.com/package/ipa-tools))
