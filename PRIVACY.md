...
- **OpenAI:** chat messages (and, when the user allows experimental image input, image bytes from the page) and the stored OpenAI API key are sent to `https://api.openai.com` for the selected model.
